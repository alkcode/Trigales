...
// 	$sentencia->execute([$producto->id_producto, $producto->cantidad, $producto->p_medio, $producto->total, $idVenta]);
// 	//ejemplo
...
foreach($_SESSION["carrito"] as $producto){
	$total += $producto->total;
	$sentencia->execute([$producto->id_producto, $producto->cantidad, $producto->p_medio, $producto->total, $idVenta, $stock]);
}
