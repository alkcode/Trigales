...
$ahora = date("Y-m-d H:i:s");
		...
		// 	$sentencia->execute([$producto->id_producto, $producto->cantidad, $producto->p_mayoreo, $producto->total, $idVenta]);
		// 	//ejemplos
		...
		foreach($_SESSION["carrito"] as $producto){
			$total += $producto->total;
			$sentencia->execute([$producto->id_producto, $producto->cantidad, $producto->p_mayoreo, $producto->total, $idVenta, $stock]);
		}
